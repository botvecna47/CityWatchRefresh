...
interface SpamReportModalProps {
  showSpamModal?: boolean; // Keep for backwards compatibility if needed, but AnimatePresence will unmount it
...
export const SpamReportModal = React.forwardRef<HTMLDivElement, SpamReportModalProps>(
  ({ setShowSpamModal, spamReason, setSpamReason, confirmReportSpam }, ref) => {
    return (
...
SpamReportModal.displayName = "SpamReportModal";
